...
const RADAR_BACK_HOME_HTML = `<a class="radar-back-home-link" href="/">Voltar para o Orceu</a>`;

const RADAR_STATE_SELECTOR_STYLES = `.radar-state-select-wrap{display:flex;align-items:center;padding:0 0 0 8px!important;margin-left:0;border-left:1px solid rgba(255,255,255,.12);flex:0 0 auto;height:100%}.radar-state-select{appearance:none;width:46px!important;height:22px!important;border:0;border-radius:999px;background-color:rgba(255,255,255,.08);color:#eef3ff;cursor:pointer;font-family:'Axiforma',sans-serif;font-size:9.5px!important;font-weight:700;letter-spacing:.04em;line-height:1;padding:0 15px 0 8px;text-transform:uppercase;background-image:linear-gradient(45deg,transparent 50%,#eef3ff 50%),linear-gradient(135deg,#eef3ff 50%,transparent 50%);background-position:calc(100% - 9px) 50%,calc(100% - 6px) 50%;background-size:3px 3px,3px 3px;background-repeat:no-repeat;text-align:left}.radar-state-select option{color:#2146ad;background:#fff}.radar-back-home-link{display:inline-flex!important;align-items:center!important;justify-content:center!important;height:22px!important;margin-left:6px;padding:0 11px!important;border-radius:999px;background:rgba(255,255,255,.08)!important;color:#eef3ff!important;font-family:'Axiforma',sans-serif;font-size:8.8px!important;font-weight:700;letter-spacing:.035em;line-height:1!important;text-decoration:none!important;text-transform:uppercase;white-space:nowrap;flex:0 0 auto;align-self:center}.radar-back-home-link::before{content:"";margin-right:5px;width:5px;height:5px;border-left:1.5px solid currentColor;border-bottom:1.5px solid currentColor;transform:rotate(45deg);line-height:1}.cat-inner .radar-back-home-link,.cat-inner .radar-state-select-wrap{padding-top:0!important;padding-bottom:0!important}`;
...
const MASTHEAD_BRAND_FIXED_HTML = `<div style="display:flex;align-items:center;justify-content:flex-start;flex:1 1 auto;min-width:0">
