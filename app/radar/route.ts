...
const MASTHEAD_SEARCH_FIX =
  `<div class=\\"mh-search\\" style=\\"display:flex;align-items:center;gap:10px;border:1px solid rgba(33,70,173,.18);border-radius:2px;padding:9px 14px;min-width:240px\\">\\n        <span style=\\"color:#5B72B8;font-size:15px\\">⌕<\\/span>\\n        <span style=\\"color:#5B72B8;font-size:13px;letter-spacing:.02em\\">Buscar notícias, obras, empresas…<\\/span>\\n      <\\/div>`;
